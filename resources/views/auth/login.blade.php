            ...
            <div class="row justify-content-center">
                <div class="col-11 col-md-8 col-lg-6 col-xl-4">
                    <div class="login-card p-4 p-md-6 bg-dark bg-opacity-50 translucent-dark rounded-4"
                        ...
                        <form>
                            ...
                            <div class="d-grid mb-3">
                                <button class="btn btn-primary btn-lg bg-primary bg-opacity-75" type="submit">Sign
                                    In
                                </button>
                            </div>
                    ...
                    <div class="login-card d-none p-4 p-md-6 bg-dark bg-opacity-50 translucent-dark rounded-4"
                        ...
                        <form>
                            <div class="d-grid mb-3">
                                <button class="btn btn-lg bg-opacity-75"
                            ...
                            <div class="divider small text-white opacity-25">or</div>
                            <div class="d-grid mb-3">
                                <button class="btn btn-dark bg-opacity-50 border-dark btn-lg" id="switchToRegular"
                                        type="button">
