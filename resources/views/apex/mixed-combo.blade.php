@extends('layouts.vertical', ['pageTitle' => 'Apex Mixed/Combo Chart'])

@section('css')
@endsection

@section('page-title')
    @include('layouts.partials/app-pagetitle', ['pageTitle'=> 'Apex Mixed/Combo Chart', 'pageSubTitle1' => 'Data Visualization', 'pageSubTitle2'=> 'Apex Charts', 'pageSubText' => 'Mix it up with a chart party—perfect for tackling complex data maps, ideal for juggling multiple data, blending complex datasets.'])
@endsection
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="panel panel-icon" id="panel-1">
                <div class="panel-hdr">
                    <h2> Line Column <span class="fw-light"><i>Mixed</i></span>
                    </h2>
            ...
            <div class="panel panel-icon" id="panel-3">
                <div class="panel-hdr">
                    <h2> Line &amp; Area <span class="fw-light"><i>Mixed</i></span>
                    </h2>
                    <div class="panel-toolbar">
                        <button class="btn btn-panel" data-action="panel-collapse" data-bs-offset="0,10"
                                data-bs-original-title="Toggle" data-bs-placement="top" data-bs-toggle="tooltip"
            ...
            <div class="panel panel-icon" id="panel-5">
                <div class="panel-hdr">
                    <h2> Line Scatter <span class="fw-light"><i>Mixed</i></span>
                    </h2>
                    <div class="panel-toolbar">
                        <button class="btn btn-panel" data-action="panel-collapse" data-bs-offset="0,10"
                                data-bs-original-title="Toggle" data-bs-placement="top" data-bs-toggle="tooltip"
        ...
        <div class="col-sm-6">
            <div class="panel panel-icon" id="panel-2">
                <div class="panel-hdr">
                    <h2> Multiple Y-Axis <span class="fw-light"><i>Mixed</i></span>
                    </h2>
                    <div class="panel-toolbar">
                        <button class="btn btn-panel" data-action="panel-collapse" data-bs-offset="0,10"
                                data-bs-original-title="Toggle" data-bs-placement="top" data-bs-toggle="tooltip"
                ...
                <div class="panel-container">
                    <div class="panel-content">
                        <div id="multiple-y-axis-chart"></div>
                    </div>
                </div>
            </div>
            <div class="panel panel-icon" id="panel-4">
                <div class="panel-hdr">
                    <h2> Line Column Area <span class="fw-light"><i>Mixed</i></span>
                    </h2>
                    <div class="panel-toolbar">
                        <button class="btn btn-panel" data-action="panel-collapse" data-bs-offset="0,10"
                                data-bs-original-title="Toggle" data-bs-placement="top" data-bs-toggle="tooltip"
...
@section('scripts')
    @vite(['resources/scripts/pages/apexmixedcombochart.js'])
@endsection
