@extends('layouts.vertical', ['pageTitle' => 'Apex Scatter Chart'])

@section('css')
@endsection

@section('page-title')
    @include('layouts.partials/app-pagetitle', ['pageTitle'=> 'Apex Scatter Chart', 'pageSubTitle1' => 'Data Visualization', 'pageSubTitle2'=> 'Apex Charts', 'pageSubText' => 'Optimal for exploring data dispersion with accuracy, perfect for visualizing data distribution with precision.'])
@endsection
    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <div class="panel panel-icon" id="panel-1">
                <div class="panel-hdr">
                    <h2> Basic <span class="fw-light"><i>Scatter</i></span>
                    </h2>
                ...
                <div class="panel-container">
                    <div class="panel-content">
                        <div id="basic-scatter-chart"></div>
                    </div>
                </div>
            </div>
            <!-- Scatter - Images -->
            <div class="panel panel-icon" id="panel-3">
                <div class="panel-hdr">
                    <h2> Scatter - Images <span class="fw-light"><i>Chart</i></span>
                    </h2>
                    <div class="panel-toolbar">
                        <button class="btn btn-panel" data-action="panel-collapse" data-bs-offset="0,10"
                                data-bs-original-title="Toggle" data-bs-placement="top" data-bs-toggle="tooltip"
                ...
                <div class="panel-container">
                    <div class="panel-content">
                        <div id="images-scatter-chart"></div>
                    </div>
                </div>
            </div>
            <!-- Scatter - Image -->
            <div class="panel panel-icon" id="panel-5">
                <div class="panel-hdr">
                    <h2> Scatter - Image <span class="fw-light"><i>Chart</i></span>
                    </h2>
                    <div class="panel-toolbar">
                        <button class="btn btn-panel" data-action="panel-collapse" data-bs-offset="0,10"
                                data-bs-original-title="Toggle" data-bs-placement="top" data-bs-toggle="tooltip"
                ...
                <div class="panel-container">
                    <div class="panel-content">
                        <div id="image-scatter-chart"></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
            ...
            <div class="panel panel-icon" id="panel-2">
                <div class="panel-hdr">
                    <h2> Scatter - Datetime <span class="fw-light"><i>Chart</i></span>
                    </h2>
                    <div class="panel-toolbar">
                        <button class="btn btn-panel" data-action="panel-collapse" data-bs-offset="0,10"
                                data-bs-original-title="Toggle" data-bs-placement="top" data-bs-toggle="tooltip"
                ...
                <div class="panel-container">
                    <div class="panel-content">
                        <div id="datetime-scatter-chart"></div>
                    </div>
                </div>
            </div>
            <!-- Scatter - Category -->
            <div class="panel panel-icon" id="panel-4">
                <div class="panel-hdr">
                    <h2> Scatter - Category <span class="fw-light"><i>Chart</i></span>
                    </h2>
                    <div class="panel-toolbar">
                        <button class="btn btn-panel" data-action="panel-collapse" data-bs-offset="0,10"
                                data-bs-original-title="Toggle" data-bs-placement="top" data-bs-toggle="tooltip"
...
@section('scripts')
    @vite(['resources/scripts/pages/apexscatterchart.js'])
@endsection
