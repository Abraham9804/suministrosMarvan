@extends('layouts.vertical', ['pageTitle' => 'Apex Treemap Chart'])

@section('css')
@endsection

@section('page-title')
    @include('layouts.partials/app-pagetitle', ['pageTitle'=> 'Apex Treemap Chart', 'pageSubTitle1' => 'Data Visualization', 'pageSubTitle2'=> 'Apex Charts', 'pageSubText' => 'Used for displaying complex data relationships and showcasing hierarchical structures.'])
@endsection
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="panel panel-icon" id="panel-1">
                <div class="panel-hdr">
                    <h2> Basic <span class="fw-light"><i>Treemap</i></span>
                    </h2>
                ...
                <div class="panel-container">
                    <div class="panel-content">
                        <div id="basic-treemap-chart"></div>
                    </div>
                </div>
            </div>
            <div class="panel panel-icon" id="panel-3">
                <div class="panel-hdr">
                    <h2> Color range <span class="fw-light"><i>Treemap</i></span>
                    </h2>
                    <div class="panel-toolbar">
                        <button class="btn btn-panel" data-action="panel-collapse" data-bs-offset="0,10"
                                data-bs-original-title="Toggle" data-bs-placement="top" data-bs-toggle="tooltip"
                ...
                <div class="panel-container">
                    <div class="panel-content">
                        <div id="color-range-treemap-chart"></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="panel panel-icon" id="panel-2">
                <div class="panel-hdr">
                    <h2> Multiple Series <span class="fw-light"><i>Treemap</i></span>
                    </h2>
                    <div class="panel-toolbar">
                        <button class="btn btn-panel" data-action="panel-collapse" data-bs-offset="0,10"
                                data-bs-original-title="Toggle" data-bs-placement="top" data-bs-toggle="tooltip"
                ...
                <div class="panel-container">
                    <div class="panel-content">
                        <div id="multiple-series-treemap-chart"></div>
                    </div>
                </div>
            </div>
            <div class="panel panel-icon" id="panel-4">
                <div class="panel-hdr">
                    <h2> Distributed <span class="fw-light"><i>Treemap</i></span>
                    </h2>
                    <div class="panel-toolbar">
                        <button class="btn btn-panel" data-action="panel-collapse" data-bs-offset="0,10"
                                data-bs-original-title="Toggle" data-bs-placement="top" data-bs-toggle="tooltip"
                ...
                <div class="panel-container">
                    <div class="panel-content">
                        <div id="distributed-treemap-chart"></div>
                    </div>
                </div>
            </div>
        </div>
...
@section('scripts')
    @vite(['resources/scripts/pages/apextreemapchart.js'])
@endsection
