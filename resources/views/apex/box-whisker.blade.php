@extends('layouts.vertical', ['pageTitle' => 'Apex Box & Whisker Chart'])

@section('css')
@endsection

@section('page-title')
    @include('layouts.partials/app-pagetitle', ['pageTitle'=> 'Apex Box & Whisker Chart', 'pageSubTitle1' => 'Data Visualization', 'pageSubTitle2'=> 'Apex Charts', 'pageSubText' => 'Leverage these Apex Box & Whisker Chart variants as a starting point for custom analytical dashboards.'])
@endsection
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="panel panel-icon" id="panel-1">
                <div class="panel-hdr">
                    <h2> Basic <span class="fw-light"><i>Box &amp; Whisker</i></span>
                    </h2>
                ...
                <div class="panel-container">
                    <div class="panel-content">
                        <div id="basic-box-whisker-chart"></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="panel panel-icon" id="panel-2">
                <div class="panel-hdr">
                    <h2> Horizontal BoxPlot <span class="fw-light"><i>Box &amp; Whisker</i></span>
                    </h2>
                    <div class="panel-toolbar">
                        <button class="btn btn-panel" data-action="panel-collapse" data-bs-offset="0,10"
                                data-bs-original-title="Toggle" data-bs-placement="top" data-bs-toggle="tooltip"
                ...
                <div class="panel-container">
                    <div class="panel-content">
                        <div id="horizontal-boxplot-chart"></div>
                    </div>
                </div>
            </div>
        </div>
...
@section('scripts')
    @vite(['resources/scripts/pages/apexboxwhiskerchart.js'])
@endsection
