@extends('layouts.vertical', ['pageTitle' => 'Apex Range Area Chart'])

@section('css')
@endsection

@section('page-title')
    @include('layouts.partials/app-pagetitle', ['pageTitle'=> 'Apex Range Area Chart', 'pageSubTitle1' => 'Data Visualization', 'pageSubTitle2'=> 'Apex Charts', 'pageSubText' => 'This range area design—ideal for highlighting trends within defined boundaries — perfect for showcasing data fluctuations in a structured format.'])
@endsection
    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <div class="panel panel-icon" id="panel-1">
                <div class="panel-hdr">
                    <h2> Basic <span class="fw-light"><i>Range Area</i></span>
                    </h2>
                ...
                <div class="panel-container">
                    <div class="panel-content">
                        <div id="basic-range-area-chart"></div>
                    </div>
                </div>
            </div>
            <!-- Datetime Range Area -->
            <div class="panel panel-icon" id="panel-3">
                <div class="panel-hdr">
                    <h2> Datetime <span class="fw-light"><i>Range Area</i></span>
                    </h2>
                    <div class="panel-toolbar">
                        <button class="btn btn-panel" data-action="panel-collapse" data-bs-offset="0,10"
                                data-bs-original-title="Toggle" data-bs-placement="top" data-bs-toggle="tooltip"
                ...
                <div class="panel-container">
                    <div class="panel-content">
                        <div id="datetime-range-area-chart"></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
            ...
            <div class="panel panel-icon" id="panel-2">
                <div class="panel-hdr">
                    <h2> Combo <span class="fw-light"><i>Range Area</i></span>
                    </h2>
                    <div class="panel-toolbar">
                        <button class="btn btn-panel" data-action="panel-collapse" data-bs-offset="0,10"
                                data-bs-original-title="Toggle" data-bs-placement="top" data-bs-toggle="tooltip"
                ...
                <div class="panel-container">
                    <div class="panel-content">
                        <div id="combo-range-area-chart"></div>
                    </div>
                </div>
            </div>
            <!-- Multiple Range Area -->
            <div class="panel panel-icon" id="panel-4">
                <div class="panel-hdr">
                    <h2> Multiple <span class="fw-light"><i>Range Area</i></span>
                    </h2>
                    <div class="panel-toolbar">
                        <button class="btn btn-panel" data-action="panel-collapse" data-bs-offset="0,10"
                                data-bs-original-title="Toggle" data-bs-placement="top" data-bs-toggle="tooltip"
                ...
                <div class="panel-container">
                    <div class="panel-content">
                        <div id="multiple-range-area-chart"></div>
                    </div>
                </div>
            </div>
        </div>
...
@section('scripts')
    @vite(['resources/scripts/pages/apexrangeareachart.js'])
@endsection
