...
@section('page-title')
    @include('layouts.partials/app-pagetitle', ['pageTitle'=> 'Apex Area Chart', 'pageSubTitle1' => 'Data Visualization', 'pageSubTitle2'=> 'Apex Charts', 'pageSubText' => 'Build on a solid foundation with an area chart display.'])
@endsection
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="panel panel-icon" id="panel-1">
                <div class="panel-hdr">
                    <h2> Basic <span class="fw-light"><i>Area</i></span>
                    </h2>
                ...
                <div class="panel-container">
                    <div class="panel-content position-relative">
                        <div class="d-flex justify-content-center gap-1">
                            <button class="btn btn-xs btn-outline-default" id="one_month" type="button">1M</button>
                            <button class="btn btn-xs btn-outline-default" id="six_months" type="button">6M</button>
                            <button class="btn btn-xs btn-outline-default" id="one_year" type="button">1Y</button>
                            <button class="btn btn-xs btn-outline-default" id="ytd" type="button">YTD</button>
                            <button class="btn btn-xs btn-outline-default" id="all" type="button">All</button>
                        </div>
            ...
            <div class="panel panel-icon" id="panel-5">
                ...
                <div class="panel-container">
                    <div class="panel-content">
                        <div id="github-area-chart"></div>
                        <div id="github-area-chart-brush"></div>
                    </div>
                </div>
            </div>
            <div class="panel panel-icon" id="panel-7">
                ...
                <div class="panel-container">
                    <div class="panel-content">
                        <div id="irregular-area-chart"></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
            ...
            <div class="panel panel-icon" id="panel-4">
                ...
                <div class="panel-container">
                    <div class="panel-content">
                        <div id="negative-area-chart"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="panel panel-icon" id="panel-8">
                ...
                <div class="panel-container">
                    <div class="panel-content">
                        <div id="null-values-area-chart"></div>
                    </div>
                </div>
            </div>
        </div>
...
@section('scripts')
    @vite(['resources/scripts/pages/apexareachart.js'])
@endsection
