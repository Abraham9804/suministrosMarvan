@extends('layouts.vertical', ['pageTitle' => 'Apex Polar Area Chart'])

@section('css')
@endsection

@section('page-title')
    @include('layouts.partials/app-pagetitle', ['pageTitle'=> 'Apex Polar Area Chart', 'pageSubTitle1' => 'Data Visualization', 'pageSubTitle2'=> 'Apex Charts', 'pageSubText' => 'Build your base with a chart that’s out of this world—perfect for polar data vibes!'])
@endsection
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="panel panel-icon" id="panel-1">
                <div class="panel-hdr">
                    <h2> Basic <span class="fw-light"><i>Polar Area</i></span>
                    </h2>
                ...
                <div class="panel-container">
                    <div class="panel-content">
                        <div id="basic-polar-area-chart"></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="panel panel-icon" id="panel-2">
                <div class="panel-hdr">
                    <h2> Monochrome <span class="fw-light"><i>Polar Area</i></span>
                    </h2>
                    <div class="panel-toolbar">
                        <button class="btn btn-panel" data-action="panel-collapse" data-bs-offset="0,10"
                                data-bs-original-title="Toggle" data-bs-placement="top" data-bs-toggle="tooltip"
                ...
                <div class="panel-container">
                    <div class="panel-content">
                        <div id="monochrome-polar-area-chart"></div>
                    </div>
                </div>
            </div>
        </div>
...
@section('scripts')
    @vite(['resources/scripts/pages/apexpolarareachart.js'])
@endsection
