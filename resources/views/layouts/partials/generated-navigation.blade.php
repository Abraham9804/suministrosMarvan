<ul id="js-nav-menu" class="nav-menu">
    ...
    <li>
        <a href="#">
            ...
            <span class="nav-link-text">Sheshiny</span> <!-- belleza -->
        </a>
    </li>
    <li>
        <a href="#">
            <svg class="sa-icon sa-thin">
                <use href="icons/sprite.svg#gift"></use>
            </svg>
            <span class="nav-link-text">Organizatodo</span> <!-- Variado -->
        </a>
    </li>
    <li>
        <a href="#">
            <svg class="sa-icon sa-thin">
                <use href="icons/sprite.svg#book"></use>
            </svg>
            <span class="nav-link-text">Notitas con RR</span><!-- Libretas -->
        </a>
    </li>
    <li>
        <a href="#">
            ...
            <span class="nav-link-text">RyR Beauty</span><!-- Hogar -->
        </a>
    </li>
    <li>
        <a href="#">
