@extends('layouts.vertical', ['pageTitle' => 'Typography'])
...
@section('page-title')
    @include('layouts.partials/app-pagetitle', ['pageTitle'=> 'Typography', 'pageSubTitle1' => 'Design', 'pageSubTitle2'=> 'System Utilities', 'pageSubText' => 'Documentation and examples for typography, including global settings, headings, body text, lists, and more.'])
@endsection
        ...
        <div class="col-lg-12 col-xl-6">
            ...
            <div class="panel panel-icon" id="panel-6">
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        ...
                        <p class="m-0"><abbr class="initialism" title="HyperText Markup Language">HTML</abbr></p>
                    </div>
                </div>
            </div>
            ...
            <div class="panel panel-icon" id="panel-8">
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        <div class="panel-tag">
                            Wrap text with a <code>.text-wrap</code> class, to prevent text from wrapping with a <code>.text-nowrap</code>
                            class
                        </div>
                        <div class="demo-v-spacing">
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        <div class="panel-tag">
                            ...
                            with an ellipsis. <span class="fw-400">Requires</span> <code>display: inline-block</code> or
                            <code>display: block</code>. You can also combine the following classe
                            <code>.text-truncate</code> and combine with <code>.text-truncate-xs</code>, <code>.text-truncate-sm</code>,
                            <code>.text-truncate-md</code>, <code>.text-truncate-default</code>, and <code>.text-truncate-lg</code>
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        <div class="panel-tag">
                            ...
                            italicize text with <code>.font-italic</code>. Reset boldness of text with <code>.font-weight-bold</code>.
                            Try various font weights using <code>.fw-{300,400,500,700,900}</code>
                        </div>
                        <div class="frame-wrap">
                            <div class="demo-v-spacing">
                                ...
                                <p class="m-0"><span class="fw-900"><u>Sample boldest &amp; underline text</u></span>
                                </p>
                            </div>
                        </div>
                        <div class="frame-wrap">
                            <div class="demo-v-spacing">
                                ...
                                <p><span class="fw-900 text-uppercase font-italic">Boldest text with uppercase &amp; italic font</span>
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        ...
                        <div class="demo-v-spacing">
                            ...
                            <p class="text-muted">
                                Muted text with a <a class="text-reset" href="#">reset link</a>.
                            </p>
                        </div>
                    </div>
                </div>
...
<span class="h6 p-3">
                    ...
                    <div class="panel-content">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="demo-v-spacing">
                                        ...
                                        <p><a href="#"><span
                                                    class="fw-300 font-italic">Sample light &amp; italic text</span></a>
                                        </p>
                                        <p class="m-0"><a href="#"><span class="fw-900"><u>Sample boldest &amp; underline text</u></span></a>
                                        </p>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="demo-v-spacing">
                                        <p><a class="disabled" href="#"><span>Sample text</span></a></p>
                                        <p><a class="disabled" href="#"><span
                                                    class="fw-300">Sample light text</span></a></p>
                                        <p><a class="disabled" href="#"><span class="fw-500">Sample bold text</span></a>
                                        </p>
                                        <p><a class="disabled" href="#"><span
                                                    class="fw-700">Sample bolder text</span></a></p>
                                        <p><a class="disabled" href="#"><span class="fw-900">Sample boldest text</span></a>
                                        </p>
                                        <p><a class="disabled" href="#"><span class="fw-300 font-italic">Sample light &amp; italic text</span></a>
                                        </p>
                                        <p><a class="disabled" href="#"><span class="fw-900"><u>Sample boldest &amp; underline text</u></span></a>
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="frame-wrap">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="demo-v-spacing">
                                        <p><a class="text-primary" href="#">Primary state</a></p>
                                        <p><a class="text-success" href="#">Success state</a></p>
                                        <p><a class="text-warning" href="#">Warning state</a></p>
                                        <p><a class="text-info" href="#">Info state</a></p>
                                        <p><a class="text-danger" href="#">Danger state</a></p>
                                        <p><a class="text-secondary" href="#">Secondary state</a></p>
                                        <p><a class="text-muted" href="#">Muted state</a></p>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="demo-v-spacing">
                                        <p><a class="text-primary disabled" href="#">Primary state</a></p>
                                        <p><a class="text-success disabled" href="#">Success state</a></p>
                                        <p><a class="text-warning disabled" href="#">Warning state</a></p>
                                        <p><a class="text-info disabled" href="#">Info state</a></p>
                                        <p><a class="text-danger disabled" href="#">Danger state</a></p>
                                        <p><a class="text-secondary disabled" href="#">Secondary state</a></p>
                                        <p><a class="text-muted disabled" href="#">Muted state</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <!--List styles-->
            <div class="panel panel-icon" id="panel-15">
                <div class="panel-hdr">
                    <h2>
            ...
            <div class="panel panel-icon" id="panel-16">
                <div class="panel-hdr">
                    <h2>
            ...
            <div class="panel panel-icon" id="panel-17">
                <div class="panel-hdr">
                    <h2>
            ...
            <div class="panel panel-icon" id="panel-18">
                <div class="panel-hdr">
                    <h2>
