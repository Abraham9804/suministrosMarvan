@extends('layouts.vertical', ['pageTitle' => 'Flexbox'])
...
@section('page-title')
    @include('layouts.partials/app-pagetitle', ['pageTitle'=> 'Flexbox', 'pageSubTitle1' => 'Design', 'pageSubTitle2'=> 'System Utilities', 'pageSubText' => 'Quickly manage the layout, alignment, and sizing of grid columns, navigation, components, and more with a full suite of responsive flexbox utilities.'])
@endsection
        ...
        <div class="col-lg-12">
            <div class="card mb-g">
                <div class="card-body">
                    <h5 class="mb-g">
                        ...
                        <small>
                            Apply <code>display</code> utilities to create a flexbox container and transform <strong>direct
                                children elements</strong> into flex items. Flex containers and items are able to be
            ...
            <div class="card mb-g">
                <div class="card-body">
                    ...
                    <h5 class="frame-heading">
                        Use <code>.flex-row</code> to set a horizontal direction (the browser default), or <code>.flex-row-reverse</code>
                ...
                <div class="card-body">
                    <h5 class="mb-g">
                        ...
                        <small>
                            ...
                            items on the cross axis (the y-axis to start, x-axis if <code>flex-direction: column</code>).
                        </small>
                    </h5>
                    <h5 class="frame-heading">
                ...
                <div class="card-body">
                    <h5 class="mb-g">
                        ...
                        <small>
                            ...
                            margin), pushing two items to the right (<code>.me-auto</code>), and pushing two items to
                            the left (<code>.ms-auto</code>).
                        </small>
                    </h5>
                    <div class="frame-wrap">
            ...
            <div class="card mb-g">
                <div class="card-body">
                    <h5 class="mb-g">
                        ...
                        <small>
                            Use <code>align-content</code> utilities on flexbox containers to align flex items <em>together</em>
                            on the cross axis. Choose from <code>start</code> (browser default), <code>end</code>,
                            <code>center</code>, <code>between</code>, <code>around</code>, or <code>stretch</code>. To
                            demonstrate these utilities, we’ve enforced <code>flex-wrap: wrap</code> and increased the
