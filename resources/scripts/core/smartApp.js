...
import {Navigation} from './smartNavigation'
import {mobileOperator, savePanelState, saveSettings, resetSettings} from './saveloadscript'
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const navElement = document.querySelector('#js-nav-menu');
    const searchElement = document.querySelector('#searchInput');
    if (navElement && searchElement) {
    ...
    window.appDOM = (function () {
        ...
        const handlers = {
                                        ...
                                        <div class="modal-header border-bottom-0">
                                            ...
                                            <button type="button" class="btn btn-system btn-system-light ms-auto" data-bs-dismiss="modal" aria-label="Close">
                                                <svg class="sa-icon sa-icon-2x">
                                                    <use href="/public/img/sprite.svg#x"></use>
                                                </svg>
                                            </button>
                                        </div>
            ...
            removeClass: function (element) {
                ...
                if (target === 'html' && typeof saveSettings === 'function') {
                    saveSettings();
                    plugin.checkActiveStyles();
                    logger.log('Settings saved');
                }
